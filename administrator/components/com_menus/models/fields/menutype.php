...
class JFormFieldMenutype extends JFormFieldList
{
	...
	protected function getInput()
	{
		...
		$html[] = '<input class="btn btn-primary" type="button" value="'.JText::_('JSELECT').'" onclick="SqueezeBox.fromElement(this, {handler:\'iframe\', size: {x: 600, y: 450}, url:\''.JRoute::_('index.php?option=com_menus&view=menutypes&tmpl=component&recordId='.$recordId).'\'})" />';
